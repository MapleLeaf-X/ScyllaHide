...
typedef NTSTATUS (NTAPI * NtWow64ReadVirtualMemory64_t)(HANDLE ProcessHandle,
	PVOID64 BaseAddress, PVOID Buffer, ULONGLONG BufferSize, PULONGLONG NumberOfBytesRead);
typedef NTSTATUS (NTAPI * NtWow64WriteVirtualMemory64_t)(HANDLE ProcessHandle,
	PVOID64 BaseAddress, LPCVOID Buffer, ULONGLONG BufferSize, PULONGLONG NumberOfBytesWritten);
